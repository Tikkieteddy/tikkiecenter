    ...
    <main className="min-h-screen overflow-hidden bg-[radial-gradient(circle_at_14%_0%,rgba(0,165,255,0.32),transparent_30%),radial-gradient(circle_at_92%_8%,rgba(255,230,109,0.2),transparent_24%),linear-gradient(145deg,#070044_0%,#12007c_44%,#1700c7_72%,#00a5ff_100%)] text-brand-yellow">
      <div className="mx-auto flex min-h-screen w-full max-w-7xl flex-col px-4 py-5 sm:px-6 lg:px-8">
        <header className="flex items-center justify-between gap-4">
          ...
          <a
            href="https://tikkiecenter.vercel.app/login"
            className="inline-flex min-h-10 items-center justify-center gap-2 rounded-lg border border-brand-yellow/40 bg-brand-yellow px-4 text-sm font-black text-brand-900 shadow-[0_14px_36px_rgba(255,230,109,0.24)] transition hover:-translate-y-0.5 hover:bg-brand-yellow-soft"
          >
            เข้าระบบ
                ...
                >
                  ...
                  <div className="relative flex h-full flex-col">
                    <div className="flex items-start justify-between gap-3">
                      ...
                      <span className="inline-flex items-center gap-1 rounded-full border border-brand-yellow/30 bg-brand-yellow px-3 py-1 text-xs font-black text-brand-900">
                        Open
